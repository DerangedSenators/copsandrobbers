    ...
    public class RoundManager : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            if (localPlayerRB == null)
            {
                ...
                localPlayerRB = Player.Player.LocalPlayer.GetComponent<Rigidbody2D>();
            }

            if (localIndex == -1) localIndex = Player.Player.LocalPlayer.playerIndex;
        ...
        {
            if (Player.Player.LocalPlayer.teamId == 1)
